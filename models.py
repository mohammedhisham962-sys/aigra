...
class User(Base):
    ...
    email = Column(String(120), unique=True, nullable=True) # Make nullable for quick registration
    password_hash = Column(String(256), nullable=True) # Make nullable for quick registration
    role = Column(String(20), default='Analyst')  # Admin or Analyst
    points = Column(Integer, default=0)
    completed_quests = Column(Text, default='') # Comma separated quest IDs
